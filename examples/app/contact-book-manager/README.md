...
A full-featured contact book manager built with **webhub SSR** and webhub Framework client hydration. Demonstrates Atomic Design component architecture, IndexedDB offline storage, client-side routing, and responsive layout - all rendered server-side with the `--plugin=webhub` pipeline.
