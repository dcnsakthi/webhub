...
// This file is @generated by prost-build from proto/webhub.proto.
...
pub struct ComponentData {
    /// Non-webhub client-side template payload.
...
pub struct webhubProtocol {
    ...
    /// Whether initial SSR metadata contains full state or webhub component
...
pub struct FragmentList {
    ...
    pub fragments: ::prost::alloc::vec::Vec<webhubFragment>,
}
...
/// Nested message and enum types in `webhubFragment`.
pub mod web_ui_fragment {
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Fragment {
        #[prost(message, tag = "1")]
        Raw(super::webhubFragmentRaw),
        #[prost(message, tag = "2")]
        Component(super::webhubFragmentComponent),
        #[prost(message, tag = "3")]
        ForLoop(super::webhubFragmentFor),
        #[prost(message, tag = "4")]
        Signal(super::webhubFragmentSignal),
        #[prost(message, tag = "5")]
        IfCond(super::webhubFragmentIf),
        #[prost(message, tag = "6")]
        Attribute(super::webhubFragmentAttribute),
        #[prost(message, tag = "7")]
        Plugin(super::webhubFragmentPlugin),
        #[prost(message, tag = "8")]
        Route(super::webhubFragmentRoute),
        #[prost(message, tag = "9")]
        Outlet(super::webhubFragmentOutlet),
    }
}
...
pub struct webhubFragmentRoute {
    ...
    pub children: ::prost::alloc::vec::Vec<webhubFragmentRoute>,
...
/// webhub framework does not interpret this data — it is a pass-through conduit.
...
pub enum InitialStateStrategy {
    /// Emit the complete state object. Used by default and non-webhub plugins.
    Full = 0,
    /// Select state from reachable webhub component surfaces.
    Components = 1,
}
