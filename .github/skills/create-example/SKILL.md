---
name: create-example
description: Create a runnable webhub example with app structure, theme wiring, Playwright tests, demo metadata, and demo-shell registration.
---
...
2. Use the shared theme for example UI: add `@microsoft/webhub-examples-theme`, pass `--theme=@microsoft/webhub-examples-theme`, and inject `/*{{{tokens.light}}}*/` plus `/*{{{tokens.dark}}}*/` in the entry template.
